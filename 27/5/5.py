...
Необходимо определить количество троек чисел,
в которых все числа кратны 19.
...
количество троек чисел, в которых все числа кратны 19.
...
Для указанных входных данных значением искомой суммы должно быть число 4.
