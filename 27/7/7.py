...
Программа должна вывести в первой строке одно число: количество пар чисел, разность которых кратна 69.
...
Для указанных входных данных значением искомой суммы должно быть число 3.
...
"""
f = [int(q) for q in open('B7.txt')]
g = [0 for i in range(69)]
for i in f:
    g[i%69]+=1
s = g[0]*(g[0]-1)
for j in range(1,69):
